...
{
	AppendToCommand(cmd, "-L src/include/");
}

void AppendOutput(Command *cmd)
{
	#if defined(PLATFORM_WINDOWS)
		AppendToCommand(cmd, "-o", "BScript.exe");
	#elif defined(PLATFORM_MACOS)
		AppendToCommand(cmd, "-o", "BScript");
	#elif defined(PLATFORM_LINUX)
		AppendToCommand(cmd, "-o", "BScript");
	#endif
...
void ExecRule(void)
{
	...
	#if defined(PLATFORM_WINDOWS)
		AppendToCommand(execCommand, "BScript.exe");
	#else
		AppendToCommand(execCommand, "./BScript");
	#endif
